    ...
    <form class="login-form" method="post" action="student_register">
      <h3>Basic Details</h3>
				...
				Candidate Mobile No: <input type="text" name="gs_mobile" value=""
					...
					type="date" name="gs_dob" value="" max="2019-07-20"
					placeholder="Candidate Date of Birth" required> Candidate
				Aadhar no: <input type="text" name="gs_aadhar" maxlength="12" minlength="12"
				...
				Bank IFSC Code: <input type="text" name="gs_ifsc"
					...
					name="gs_account_no" value="" placeholder="Account Number" maxlength="16" minlength="16" required>

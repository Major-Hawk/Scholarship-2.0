...
public class StudentDao {
	...
	public int saveData(StudentRegister st)
	{
		...
		String query="insert into gr12_Students values('"+st.getGs_name()+"','"+st.getGs_dob()+"',"+st.getGs_mobile()+",'"+st.getGs_email()+"','"+st.getGs_insname()+"',"+st.getGs_aadhar()+",'"+st.getGs_bank_name()+"','"+st.getGs_ifsc()+"',"+st.getGs_account_no()+",'"+hash+"','"+st.getGs_state()+"',0,0,0,0,'no caste','not approved')";
